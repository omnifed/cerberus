...
import { DEMOS } from '@/app/docs/components/[slug]/components/tag/static'
import { NonDestructivePreview } from '@/app/docs/components/[slug]/components/prompt-modal/static'
import { CustomConfigDemo } from '@/app/docs/components/[slug]/components/notifications/static'
...
<CodePreview preview={<DEMOS.basic.preview />} />
