...
| `data-part` | `root, label, control, input, trigger, clearTrigger, positioner, content, viewControl, prevTrigger, nextTrigger, viewTrigger, rangeText, yearSelect, monthSelect, view, table, tableHead, tableBody, tableRow, tableHeader, tableCell, tableCellTrigger` | The part of the component.         |
