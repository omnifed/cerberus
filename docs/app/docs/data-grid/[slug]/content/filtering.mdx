...
import { DEMOS } from '@/examples/data-grid/filtering'
...
<Example path="data-grid/filtering" demo="global" />
...
<Example path="data-grid/filtering" demo="compare" />
...
<Example path="data-grid/filtering" demo="operators" />
