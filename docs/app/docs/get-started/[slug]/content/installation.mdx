...
<NoteAdmonition
  description={
    <>
      If using Deno, simply setup your import map to include the{' '}
      <code>styled-system/\*</code> alias.
    </>
  }
/>
...
<CodeSnippet snippet={DEMOS.reactPanda} />
...
<CodeSnippet snippet={DEMOS.multiTheme} />

### Tip: Add a Cerberus script

<NoteAdmonition description="If using pnPm, you can utilize the catalogs feature instead which provides a better experience for managing dependencies." />
