...
Depending on your goals will determine how to you the query. The following sections outline the different use cases depending on whether you are fetching data within a component or outside of one.
