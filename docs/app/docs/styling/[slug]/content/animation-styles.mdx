...
import { AnimationStylesDemo, EmphasizedDemo } from "../components/animation-styles/static"
...
<CodePreview preview={<EmphasizedDemo />}>
```tsx
import { Box, EmphasizedSlideIn } from "styled-system/jsx"

<EmphasizedSlideIn>
  <Box>This content will slide in with emphasis</Box>
</EmphasizedSlideIn>
```
</CodePreview>
