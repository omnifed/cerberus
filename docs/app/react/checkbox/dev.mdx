...
} from '@/app/react/checkbox/components/indeterminate-preview'
...
import { Checkbox } from '@cerberus/react'
import { VStack, Box } from '@cerberus/styled-system/jsx'
...
| -------- | ------- | ------------------------------------------------------ |
| size     |  `md`   | This size of the Checkbox.                             |
