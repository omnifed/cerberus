...
import { LivePlayground } from '@/app/react/combobox/components/live-preview'

## Usage

<WhenToUseAdmonition description="Use a combobox field when someone needs to make a single choice from a long-list of options." />
