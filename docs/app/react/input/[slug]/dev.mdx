...
import { SearchInputExample } from '@/app/react/input/components/static-playground'
...
<CodePreview preview={<SearchInputExample />}>
```tsx title="search-input.tsx"
import { Field, Input, type InputProps } from '@cerberus/react'
import { Search } from '@carbon/icons-react'

export function SearchInputExample(props: InputProps) {
  return (
    <form action={someAction} method="post">
      <Field
        ids={{
