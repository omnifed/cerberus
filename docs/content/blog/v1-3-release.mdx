...
<Example path="signals/untrack" demo="basic" />
<br />
...
<CodeSnippet snippet="const data = useQuery(myQuery(props.id))" />
<br />
...
<Example path="signals/fetching" demo="server" />
...
<Example path="signals/fetching" demo="client" />
<br />
...
<Example path="signals/fetching" demo="streaming" />
<br />
