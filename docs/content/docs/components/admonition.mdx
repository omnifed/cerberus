...
<Example path="components/admonition" demo="basic" />
...
<Example path="components/admonition" demo="palette" />
...
<Example path="components/admonition" demo="usage" />

## Customizing

You can customize the Admonition any way you like with style props and data-selectors.

<Example path="components/admonition" demo="custom" />
