...
<Example path="components/avatar" demo="next" />

## Customization

You can customize the Avatar any way you like with style props and data-selectors.

<Example path="components/avatar" demo="custom" />
