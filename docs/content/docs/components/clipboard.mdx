...
<Example path="components/clipboard" demo="basic" />

## Button

Use the `asChild` prop on the `Clipboard.Trigger` to create a copy button.

<Example path="components/clipboard" demo="button" />
...
<Example path="components/clipboard" demo="input" />

## Store

Use the `useClipboard` hook to create a fully custom solution.

<Example path="components/clipboard" demo="store" />
