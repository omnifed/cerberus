...
<Example path="components/date-picker" demo="basic" />
...
<Example path="components/date-picker" demo="range" />
...
<Example path="components/date-picker" demo="rangeDefault" />
...
<Example path="components/date-picker" demo="custom" />
...
<NoteAdmonition
  description={
    <>
      View the{' '}
      <a
        href="https://react-spectrum.adobe.com/internationalized/date/CalendarDate.html"
        target="_blank"
        rel="no-referrer"
      >
        CalendarDate documentation
      </a>{' '}
...
<NoteAdmonition
  description={
    <>
      View the{' '}
      <a
        href="https://react-spectrum.adobe.com/internationalized/date/CalendarDate.html#introduction"
        target="_blank"
        rel="no-referrer"
      >
        parseDate documentation
      </a>{' '}
      for more details on how to use it.
    </>
  }
...
<NoteAdmonition
  description={
    <>
      View the{' '}
      <a
        href="https://react-spectrum.adobe.com/internationalized/date/DateFormatter.html"
        target="_blank"
        rel="no-referrer"
      >
        DateFormatter documentation
      </a>{' '}
      for more details on how to use it.
    </>
  }
