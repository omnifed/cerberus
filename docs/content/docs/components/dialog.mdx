...
<Example path="components/dialog" demo="controlled" />
...
<Example path="components/dialog" demo="root" />
...
<Example path="components/dialog" demo="non" />
...
<Example path="components/dialog" demo="behavior" />
...
<Example path="components/dialog" demo="dynamic" />
