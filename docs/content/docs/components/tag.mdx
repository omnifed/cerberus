...
<Example path="components/tag" demo="basic" />

## Usage Variants

Use the `usage` prop to change the style of the tag.

<Example path="components/tag" demo="usage" />

## Shape Variants

Use the `shape` prop to change the shape of the tag.

<Example path="components/tag" demo="shape" />
...
<Example path="components/tag" demo="palette" />
...
<Example path="components/tag" demo="gradient" />
