...
<CodeSnippet snippet={`import { Poppins, Recursive } from 'next/font/google'
...
<CodeSnippet
  snippet={`function RootLayout({ children }) {
    return (
...
<Example path="components/context" demo="basic" />
<br />
...
Add a custom script utilizing catalogs to manage Cerberus and PandaCSS dependencies to ensure everything updates together.
