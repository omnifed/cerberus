---
title: Focus Ring
description: Learn how to style focus rings with Cerberus.
...
Cerberus provides the `focusRing` and `focusVisibleRing` style props to style
...
<Example path="styling/compositions" demo="focusRing" />
