import { type SecondaryActionTokens, createSemanticToken } from '@cerberus/tokens'
...
export const secondaryActionTokens: SecondaryActionTokens = {
  secondaryAction: {
    bg: {
      initial: createSemanticToken(THEME, 'secondary-action.background.initial'),
    ...
    navigation: {
      initial: createSemanticToken(THEME, 'secondary-action.text.navigation.initial'),
      hover: createSemanticToken(THEME, 'secondary-action.text.navigation.hover'),
      visited: createSemanticToken(THEME, 'secondary-action.text.navigation.visited'),
    },
