...
function styledFn(Dynamic, configOrCva = {}, options = {}) {
  ...
  const CerberusComponent = /* @__PURE__ */ forwardRef(
    function CerberusComponent(props, ref) {
  ...
  CerberusComponent.displayName = `cerberus.${name}`
  CerberusComponent.__cva__ = __cvaFn__
  CerberusComponent.__base__ = __base__
  CerberusComponent.__shouldForwardProps__ = shouldForwardProp
...
export const cerberus = /* @__PURE__ */ createJsxFactory()
